...
# Adapted For UV-K5 CEC F4INX custom software By F4INX
#
...
FLOCK_LIST = ["Default+ (137-174, 400-470 + Tx200, Tx350, Tx500)",
              ...
              "CE HAM+PMR (144-146, 430-440, 446.0-446.2)",
...
WELCOME_LIST = ["Full screen test", "User message", "Battery voltage", "Battery voltage + logo", "None"]
...
class UVK5RadioCecF4inx(uvk5.UVK5RadioBase):
    """Quansheng UV-K5 (CEC F4INX)"""
    VENDOR = "Quansheng"
    MODEL = "UV-K5"
    VARIANT = "cec f4inx"
    BAUD_RATE = 38400
    ...
    def k5_approve_firmware(cls, firmware):
        return firmware.startswith('CEC_F4INX')
